...
# Running as ``python src/prototyping/ct_eval.py`` puts this folder on sys.path and
# shadows stdlib ``locale`` (prototyping/locale.py) once torch/subprocess import.
import os
import sys
