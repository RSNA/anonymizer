...
from prototyping.falcon import load_models
...
def test_falcon_model_dir_under_prototyping_package() -> None:
    expected = Path(load_models.__file__).resolve().parent / "assets" / "models"
...
@patch("prototyping.falcon.predict.load_falcon_models")
...
@patch("prototyping.falcon.predict.load_falcon_models")
@patch("prototyping.falcon.predict.preprocess_series")
...
@patch("prototyping.falcon.predict.load_falcon_models")
@patch("prototyping.falcon.predict.preprocess_series")
@patch("prototyping.falcon.predict.get_body_part_probabilities")
