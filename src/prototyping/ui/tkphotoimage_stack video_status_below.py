...
class ImageViewer:
    ...
    def __init__(self, master, num_images=1000, image_width=800, image_height=800):
        ...
        # --- UI Elements ---
        # Image Label (packed first, at the top)
        self.image_label = tk.Label(master)
        self.image_label.pack(side=tk.TOP)  # Pack at the top
        ...
        self.status_label = tk.Label(self.control_frame, text=f"1/{self.num_images}")
