...
Security fixes are applied to the current **V19** release line on `master` (stable `19.0.x`), the **V19.1** development line (`19.1.0.dev*`), and the matching packages on [PyPI](https://pypi.org/project/rsna-anonymizer/).
