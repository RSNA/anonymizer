...
**La version 19.0.9** est la version V19 actuelle sur la branche `master` et sur PyPI. Nécessite **Python 3.11 ou 3.12** avec **tkinter** intégré. Python 3.13 n’est pas pris en charge.
...
L’interface de bureau a besoin de **tkinter**. Installez un Python qui l’inclut, créez le venv et installez **19.0.9** :
