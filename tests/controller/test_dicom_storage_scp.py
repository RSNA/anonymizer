...
def test_send_cr1(temp_dir: str, controller):
    ...
    assert controller.anonymizer.model.get_anon_uid(ds.SOPInstanceUID) == f"{TEST_UIDROOT}.{TEST_SITEID}.{1}"
    assert controller.anonymizer.model.get_anon_uid(ds.StudyInstanceUID) == f"{TEST_UIDROOT}.{TEST_SITEID}.{2}"
    assert controller.anonymizer.model.get_anon_uid(ds.SeriesInstanceUID) == f"{TEST_UIDROOT}.{TEST_SITEID}.{3}"
