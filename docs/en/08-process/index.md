...
| --- | --- | --- | --- |
| 8.1 | [Remove Pixel PHI](02-remove-burned-in-text/) (burned-in text) | **`davidson_cxr`** | Whitelist → Frame → Detect → Remove |
| 8.2 | [Harmonize names](03-harmonize-names/) | **`Brain_Ax_EarlyArt`** | Harmonize Description → Segment Brain Features |
...
2. Walk **Remove Pixel PHI** on `davidson_cxr`.
