...
**La versión 19.0.9** es la versión V19 actual en la rama `master` y en PyPI. Requiere **Python 3.11 o 3.12** con **tkinter** incluido. Python 3.13 no es compatible.
...
La interfaz de escritorio necesita **tkinter**. Instale un Python que lo incluya, cree el venv e instale **19.0.9**:
