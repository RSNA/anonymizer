...
**La versión 19.0.10** es la versión V19 actual en la rama `master` y en PyPI. Requiere **Python 3.11–3.14** con **tkinter** incluido. Se recomienda **3.12**; evite **3.14.1** (torchvision excluye ese parche).
